...
jQuery(document).ready(function($){
	...
	// To enable Flickr uncomment the line below and enter your flickr id in place of the xxxxxx@xxx
	//$.getJSON("http://api.flickr.com/services/feeds/groups_pool.gne?id=xxxxxx@xxx&lang=en-us&format=json&jsoncallback=?", displayImages);
